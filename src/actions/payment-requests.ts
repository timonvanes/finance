...
export async function getPaymentRequests() {
  ...
  const { data, error } = await supabase
    ...
    .select(
      ...
      people(name),
      reclaims(id, computed_amount, source_total_amount, note, receipt_path, transactions!reclaims_transaction_id_fkey(booking_date, counterparty_name, raw_description, amount)),
